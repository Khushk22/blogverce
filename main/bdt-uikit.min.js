...
(function(ve, we) {
    typeof exports == "object" && typeof module < "u" ? module.exports = we() : typeof define == "function" && define.amd ? define("uikit", we) : (ve = typeof globalThis < "u" ? globalThis : ve || self, ve.bdtUIkit = we())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: ve,
    ...
    const Qo = /\B([A-Z])/g,
        Mt = rt(t => t.replace(Qo, "-$1").toLowerCase()),
        tr = /-(\w)/g,
        be = rt(t => (t.charAt(0).toLowerCase() + t.slice(1)).replace(tr, (e, i) => i.toUpperCase())),
        St = rt(t => t.charAt(0).toUpperCase() + t.slice(1));
    ...
    function p(t, e, i) {
        ...
        for (const n of T(t)) et(i) && (i = i.call(n, p(n, e))), i === null ? ke(n, e) : n.setAttribute(e, i)
    }
    ...
    function qi(t) {
        return T(t).some(e => ir[e.tagName.toLowerCase()])
    }
    ...
    const rr = /.*?[^\\](?![^(]*\))(?:,|$)/g,
        ar = rt(t => t.match(rr).map(e => e.replace(/,$/, "").trim()));
    ...
    function Ji(t) {
        return Q(t) ? t.map(dr).filter(Boolean) : N(t) ? Pe(t) : Us(t) ? [t] : T(t)
    }
    ...
    const Ki = "bdt-transition",
        Zi = "transitionend",
        Qi = "transitioncanceled";
    ...
    function Ys(t, e, i = 200, s, n) {
        return Promise.all(T(t).map(o => new Promise((r, a) => {
            ...
            H(o, [Vs, ai], ({
                ...
                self: !0
            }), c(o, "animationDuration", `${i}ms`), $(o, e, _e + (n ? "leave" : "enter")), dt(e, _e) && (s && $(o, `bdt-transform-origin-${s}`), n && $(o, `${_e}reverse`))
        })))
    }
    const mr = new RegExp(`${_e}(enter|leave)`),
        At = { in: Ys,
            out(t, e, i, s) {
                return Ys(t, e, i, s, !0)
            },
    ...
    function es(t, e) {
        return T(T(t).map(i => i.hasChildNodes() ? ui(It(i.childNodes), e) : L(i, e)))
    }
    ...
    const xr = /-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,
        $r = rt(t => t.toString().replace(/\s/g, "").match(xr) || []),
        yr = /(?:v[hw]|%)$/,
        kr = rt(t => (t.match(yr) || [])[0]);
    ...
    const re = typeof window < "u",
        V = re && document.dir === "rtl",
        ae = re && "ontouchstart" in window,
        le = re && window.PointerEvent,
        ft = le ? "pointerdown" : ae ? "touchstart" : "mousedown",
        pi = le ? "pointermove" : ae ? "touchmove" : "mousemove",
        Dt = le ? "pointerup" : ae ? "touchend" : "mouseup",
        he = le ? "pointerenter" : ae ? "" : "mouseenter",
        Me = le ? "pointerleave" : ae ? "" : "mouseleave",
        gi = le ? "pointercancel" : "touchcancel",
        K = {
            reads: [],
            writes: [],
            read(t) {
    ...
    const Er = re && window.ResizeObserver;

    function Be(t, e, i = {
        box: "border-box"
    }) {
        if (Er) return sn(ResizeObserver, t, e, i);
        ...
        function s(r, a, l, h) {
            return new Promise(u => {
                ...
                (function Ze() {
                    ...
                    r.scrollTop = Math[a + pt > 0 ? "max" : "min"](r.scrollTop, d + (a + pt) * Mi), Mi === 1 && (M === pt || !wt--) ? u() : (M = pt, requestAnimationFrame(Ze))
                })()
            })
        }
    ...
    function ls(t) {
        ...
        return t.ownerDocument.elementsFromPoint(e + i / 2, s).find(n => !n.contains(t) && !y(n, "bdt-togglable-leave") && (hs(n, "fixed") && dn(Te(t).reverse().find(o => !o.contains(n) && !hs(o, "static"))) < dn(n) || hs(n, "sticky") && P(n).contains(t)))
    }
    ...
    function wn(...t) {
        let e = {};
        for (const i of t)
            for (const [, , s, n] of ht) e[s] = Math.max(e[s] || 0, i[s]), e[n] = Math.min(...[e[n], i[n]].filter(Boolean));
        return e
    }
    ...
    const Fr = ["days", "hours", "minutes", "seconds"];
    var Hr = {
        mixins: [st],
        props: {
            date: String,
    ...
    function Rr(t) {
        return Q(t) ? t : N(t) ? t.split(jr).map(e => vt(e) ? $t(e) : zi(e.trim())) : [t]
    }
    ...
    function He(t = {}) {
        return Fe({
            handler: function(e, i) {
                ...
                for (const o of T(et(s) ? s(this) : s)) z('[loading="lazy"]', o).slice(0, n - 1).forEach(r => ke(r, "loading"));
    ...
    function yn(t) {
        return {
            ...
            handler(e) {
                if (!yt(e)) return;
                const i = _t(e),
                    s = "tagName" in e.target ? e.target : P(e.target);
    ...
    var kn = {
        ...
        update: {
            ...
            write({
                ...
                for (const e of t)
                    for (const i of e) j(i, this.margin, t[0] !== e), j(i, this.firstColumn, e[V ? e.length - 1 : 0] === i)
            },
            events: ["resize"]
        }
    };
    ...
    const ws = "bdt-transition-leave",
        bs = "bdt-transition-enter";
    ...
    function An(t, e) {
        return ce(X(t, e), ["filter"])
    }

    function ia(t, e) {
        return ["filter", "sort"].every(i => ei(t[i], e[i]))
    }
        ...
        Vt = {
            ...
            methods: {
                async toggleElement(t, e, i) {
                    try {
                        return await Promise.all(T(t).map(s => {
                            ...
                            const o = (et(i) ? i : i === !1 || !this.hasAnimation ? la : this.hasTransition ? ha : ca)(s, n, this),
                                r = n ? this.clsEnter : this.clsLeave;
                            $(s, r), g(s, n ? "show" : "hide", [this]);
                            const a = () => {
                                D(s, r), g(s, n ? "shown" : "hidden", [this])
                            };
                ...
                _toggle(t, e) {
                    ...
                    e = !!e;
                    let i;
                    this.cls ? (i = m(this.cls, " ") || e !== y(t, this.cls), i && j(t, this.cls, m(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), z("[autofocus]", t).some(s => q(s) ? s.focus() || !0 : s.blur()), i && g(t, "toggled", [e, this])
                }
            }
        };
    ...
    async function ha(t, e, {
        ...
        const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], d = u[m(u[0], h) ? 0 : 1], f = d[1] === h, x = ["width", "height"][u.indexOf(d)], C = `margin-${d[0]}`, M = `margin-${h}`;
        let wt = w(t)[x];
        const Ze = O.inProgress(t);
        await O.cancel(t), e && r(t, !0);
        const Mi = Object.fromEntries(["padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", C, M].map(Zo => [Zo, t.style[Zo]])),
            pt = w(t),
            me = S(c(t, C)),
            Xo = S(c(t, M)),
            Qt = pt[x] + Xo;
    ...
    var $s = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                !i && s && ne(e) && !this.$el.contains(k(s)) ? this.hide() : E(e, this.selClose) && (t.preventDefault(), this.hide())
            }
        }, {
            name: "toggle",
            self: !0,
            ...
            handler() {
                ...
                const t = [this.overlay && da(this), this.overlay && On(this.$el), this.bgClose && fa(this), this.escClose && pa(this)];
            ...
            self: !0,
            handler() {
                ni(this.$el) || p(this.$el, "tabindex", "-1"), E(this.$el, ":focus-within") || this.$el.focus()
            }
        }, {
            name: "hidden",
            self: !0,
    ...
    function fa(t) {
        return b(document, ft, ({
            target: e
        }) => {
            Bt(nt) !== t || t.overlay && !t.$el.contains(e) || t.panel.contains(e) || H(document, `${Dt} ${gi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
        ...
        return {
            ...
            show(u, d = 0, f) {
                ...
                return u -= Math.round(u * tt(d, -1, 1)), this.translate(d), $i(e, "itemin", {
                    ...
                    h || (h = x), Promise.all([O.start(e, l[1], u, v), O.start(t, l[0], u, v)]).then(() => {
                        this.reset(), h()
                    }, A)
                })
            },
    ...
    const qe = {
        ...
        ks = "touchmove mousemove",
        Nn = "touchend touchcancel mouseup click input scroll",
        zn = t => t.preventDefault();
    var wa = {
        props: {
            draggable: Boolean
        },
        ...
        methods: {
            ...
            move(t) {
                ...
                let {
                    slides: i,
                    prevIndex: s
                } = this, n = Math.abs(e), o = this.getIndex(s + this.dir), r = Fn.call(this, s, o);
                ...
                const a = i[s],
                    ...
                    u = s === o;
                let d;
                for (const f of [this.index, this.prevIndex]) m([o, s], f) || (g(i[f], "itemhidden", [this]), u && (d = !0, this.prevIndex = s));
                (this.index === s && this.prevIndex !== s || d) && g(i[this.index], "itemshown", [this]), h && (this.prevIndex = s, this.index = o, u || (g(a, "beforeitemhide", [this]), g(a, "itemhide", [this])), g(l, "beforeitemshow", [this]), g(l, "itemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), a, !u && l)
            },
            end() {
    ...
    function xa(t) {
        ...
        for (const e of t.$options.watch || [])
            for (const [i, s] of Object.entries(e)) Hn(t, s, i);
        t._initial = !0
    }
    ...
    function $a(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || gt(e, i) && !ei(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function Ca(t) {
        ...
        for (const e of t.$options.events || [])
            if (gt(e, "handler")) jn(t, e);
            else
                for (const i in e) jn(t, e[i], i)
    }
    ...
    function Ea(t) {
        ...
        for (const e of t.$options.observe || [])
            if (gt(e, "handler")) qn(t, e);
            else
                for (const i of e) qn(t, i)
    }
    ...
    function qn(t, e) {
        ...
        et(s) && !gt(t, l) && Ln(t, l, () => s.call(t, t)), n = N(n) ? t[n] : n.bind(t), et(o) && (o = o.call(t, t));
        const h = gt(t, l) ? t[l] : s,
            u = i(h, n, o, a);
    ...
    const Da = rt((t, e) => {
        const i = Object.keys(e),
            s = i.concat(t).map(n => [Mt(n), `data-${Mt(n)}`]).flat();
        return {
            attributes: i,
            filter: s
        }
    ...
    function Oa(t) {
        ...
        const {
            attributes: r,
            filter: a
        } = Da(s, n), l = new MutationObserver(h => {
            const u = Un(e);
            h.some(({
                attributeName: d
            }) => {
                const f = d.replace("data-", "");
                return (f === s ? r : [be(f), be(d)]).some(v => !G(u[v]) && u[v] !== i[v])
            }) && t.$reset()
        });
        l.observe(o, {
            attributes: !0,
    ...
    function Is(t) {
        t._connected || (Aa(t), de(t, "beforeConnect"), t._connected = !0, Ca(t), qr(t), xa(t), Ea(t), Oa(t), ka(t), de(t, "connected"), ze(t))
    }

    function Cs(t) {
        t._connected && (de(t, "beforeDisconnect"), Ta(t), Vr(t), Pa(t), Sa(t), de(t, "disconnected"), t._connected = !1)
    }
    let Ma = 0;
    ...
    function za({
        ...
        Q(t) && (t = t.slice(0, e.length).reduce((s, n, o) => (xt(n) ? mt(s, n) : s[e[o]] = n, s), {}));
    ...
    ut.util = zr, ut.options = {}, ut.version = "3.19.1";
    const Fa = "bdt-",
        Yt = "__uikit__",
        fe = {};
    ...
    function Gn(t, e) {
        ...
        for (const i of Te(t).reverse()) Xn(i, e);
        kt(t, i => Xn(i, e))
    }
            ...
            methods: {
                updateNav() {
                    ...
                    for (const e of this.navItems) {
                        ...
                        if (vt(i)) {
                            const o = $t(i) === t;
                            j(e, this.clsActive, o), j(s, "bdt-disabled", this.parallax), p(s, {
                                "aria-selected": o,
                                tabindex: o && !this.parallax ? null : -1
                            }), o && s && E(P(e), ":focus-within") && s.focus()
                        } else j(e, "bdt-invisible", this.finite && (i === "previous" && t === 0 || i === "next" && t >= this.maxIndex))
                    }
                }
            }
        },
            ...
            methods: {
                show(t, e = !1) {
                    ...
                    const r = this.getIndex(this.index),
                        a = y(this.slides, this.clsActive) && this.slides[r],
                    ...
                    if (this.dir = Ua(t, r), this.prevIndex = r, this.index = l, a && !g(a, "beforeitemhide", [this]) || !g(h, "beforeitemshow", [this, a])) {
                        this.index = this.prevIndex, o();
                        return
                    }
                    const u = this._show(a, h, e).then(() => {
                        a && g(a, "itemhidden", [this]), g(h, "itemshown", [this]), s.shift(), this._transitioner = null, requestAnimationFrame(() => s.length && this.show(s.shift(), !0))
                    });
    ...
    var Zn = {
        ...
        to = {
            ...
            created() {
                const t = k(this.template),
                    e = k(this.selList, t);
                this.items.forEach(() => L(e, "<li>"));
                const i = k("[bdt-close]", t),
                    s = this.t("close");
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), $(this.$el, "bdt-active", "bdt-transition-active")
                },
                hideControls() {
                    D(this.$el, "bdt-active", "bdt-transition-active")
                }
            }
        };
    ...
    var Ga = {
        ...
        created() {
            const t = `${this.clsContainer}-${this.pos}`,
                ...
                i = k(`.${t}[${e}]`, this.container) || L(this.container, `<div class="${this.clsContainer} ${t}" ${e}></div>`);
            this.$mount(L(i, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-bdt-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
    ...
    function Ja(t, e) {
        if (N(t)) {
            if (dt(t, "@")) t = S(c(e, `--bdt-breakpoint-${t.substr(1)}`));
        ...
        update: {
            write() {
                ...
                const t = this.parallaxTarget,
                    e = U(this.parallaxStart, "height", t, !0),
                    i = U(this.parallaxEnd, "height", t, !0),
                    s = co(wi(t, e, i), this.parallaxEasing),
                ...
                if (~this.prevIndex)
                    for (const x of new Set([this.index, this.prevIndex])) m([r, n], x) || (d(this.slides[x]), f(this.slides[x]));
    ...
    function ol(t, e, i, {
        ...
        const r = t ? Je(t, o, s) : Je(e, o, s) + w(e).width * i,
            a = e ? Je(e, o, s) : r + w(t).width * i * (V ? -1 : 1);
        let l;
        return {
            dir: i,
            show(h, u = 0, d) {
            ...
            translate(h) {
                ...
                for (const x of B(o)) {
                    const C = m(d, x),
                        M = x === f,
                        wt = x === v,
                        Ze = M || !wt && (C || i * (V ? -1 : 1) === -1 ^ Pi(x, o) > Pi(t || e));
        ...
        methods: {
            ...
            updateActiveClasses(t = this.index) {
                ...
                for (const s of this.slides) {
                    ...
                    for (const o of z(Ie, s)) gt(o, "_tabindex") || (o._tabindex = p(o, "tabindex")), p(o, "tabindex", n ? o._tabindex : -1)
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
            ...
            getIndexAt(t) {
                ...
                let s = t * i,
                    n = 0;
                do {
                    const o = w(this.slides[++e]).width,
                        r = this.center ? o / 2 + w(this.slides[e + 1]).width / 2 : o;
                    n = s / r % 1, s -= r
        ...
        dl = {
            ...
            update: {
                write(t) {
                    ...
                    const h = this.getSortable(o),
                        u = vl(r.target, l, o, e, i, r === h && t.moved !== l);
            ...
            methods: {
                init(t) {
                    ...
                    !n || s || i > 0 || Ui(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                        target: e,
                        index: Et(n),
                        ...this.pos
                ...
                start(t) {
                    ...
                    }), $(this.drag, this.clsDrag, this.clsCustom), $(this.placeholder, this.clsPlaceholder), $(this.items, this.clsItem), $(document.documentElement, this.clsDragState), g(this.$el, "start", [this, this.placeholder]), fl(this.pos), this.move(t)
                },
                move(t) {
                    ...
                    this === t ? this.origin.index !== Et(this.placeholder) && g(this.$el, "moved", [this, this.placeholder]) : (g(t.$el, "added", [t, this.placeholder]), g(this.$el, "removed", [this, this.placeholder])), g(this.$el, "stop", [this, this.placeholder]), at(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: e,
                            clsItem: i
                        } of this.touched)
                        for (const s of this.touched) D(s.items, e, i);
    ...
    function vl(t, e, i, s, n, o) {
        ...
        const a = w(i),
            ...
            [h, u, d, f] = l ? [s, "width", "left", "right"] : [n, "height", "top", "bottom"],
            v = a[u] < r[u] ? r[u] - a[u] : 0;
        ...
        const s = B(t),
            n = s.some((o, r) => {
                ...
                return s.slice(r + 1).some(l => {
                    const h = w(l);
                    return !yo([a.left, a.right], [h.left, h.right])
                })
            });
        return i && at(e), n
    }
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const n = [this.flip && "flip", this.shift && "shift"],
                    o = {
                        element: [this.inset ? this.dir : fi(this.dir), this.align],
            ...
            getPositionOffset(t = this.$el) {
                return U(this.offset === !1 ? c(t, "--bdt-position-offset") : this.offset, this.axis === "x" ? "width" : "height", t) * (m(["left", "top"], this.dir) ? -1 : 1) * (this.inset ? -1 : 1)
            },
            getShiftOffset(t = this.$el) {
                return this.align === "center" ? 0 : U(c(t, "--bdt-position-shift-offset"), this.axis === "y" ? "width" : "height", t) * (m(["left", "top"], this.align) ? 1 : -1)
            },
            getViewportOffset(t) {
                return U(c(t, "--bdt-position-viewport-offset"))
            }
        }
    };
        ...
        methods: {
            show() {
                ...
                const i = p(this.$el, "title"),
                    s = b(this.$el, ["blur", Me], o => !yt(o) && this.hide());
                this.reset = () => {
                    p(this.$el, {
                        title: i,
            ...
            async hide() {
                var t;
                E(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && await this.toggleElement(this.tooltip, !1, !1), (t = this.reset) == null || t.call(this), at(this.tooltip), this.tooltip = null)
            },
            async _show(t, e) {
                this.tooltip = L(this.container, `<div id="${e}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${t}</div> </div>`), b(this.tooltip, "toggled", (i, s) => {
                    if (!s) return;
    ...
    function Cl(t, e) {
        ...
        return Promise.resolve().then(() => i.beforeSend(i)).then(() => Tl(t, i))
    }
    ...
    var Eo = {
        ...
        events: [{
            ...
            async handler(t) {
                var e;
                t.type === "keydown" && t.keyCode !== _.SPACE || (t.preventDefault(), (e = this._off) == null || e.call(this), this._off = Ml(t.target), await this.toggle(Et(this.toggles, t.current)), this._off())
            }
        }, {
            name: "shown hidden",
            self: !0,
    ...
    async function Ol(t, e, {
        ...
        const h = zt(["marginTop", "marginBottom"], d => c(i, d)) + w(i).height,
            u = l / h;
    ...
    var Po = {
            ...
            connected() {
                this.autoplay === "inview" && !Tt(this.$el, "preload") && (this.$el.preload = "none"), R(this.$el, "iframe") && !Tt(this.$el, "allow") && (this.$el.allow = "autoplay"), this.automute && rn(this.$el)
            },
            observe: [Fe({
                filter: ({
                    $el: t,
    ...
    var Do = {
        ...
        connected() {
            $(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = Ll(this)), this._style = Hi(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        events: [{
            ...
            handler() {
                ...
                const t = [Wl(this), jl(this), ql(this), this.autoUpdate && Oo(this), this.closeOnScroll && Rl(this)];
        ...
        methods: {
            ...
            position() {
                D(this.$el, "bdt-drop-stack"), c(this.$el, this._style), this.$el.hidden = !0;
                const t = this.target.map(n => Hl(this.$el, n)),
                ...
                this.$el.hidden = !1, c(this.$el, "maxWidth", ""), this.$el.offsetWidth > s && $(this.$el, "bdt-drop-stack"), c(this.$el, "maxWidth", s), this.positionAt(this.$el, this.target, this.boundary);
    ...
    function Ll(t) {
        const {
            $el: e
        } = t.$create("toggle", J(t.toggle, t.$el), {
            target: t.$el,
            mode: t.mode
        });
    ...
    function Wl(t) {
        const e = () => t.$emit(),
            i = [os(e), Be(Ut(t.$el).concat(t.target), e)];
    ...
    function ql(t) {
        return b(document, ft, ({
            ...
            t.$el.contains(e) || H(document, `${Dt} ${gi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    var Mo = {
        ...
        watch: {
            dropbar(t) {
                $(t, "bdt-dropbar", "bdt-dropbar-top", this.clsDropbar, `bdt-${this.$options.name}-dropbar`)
            },
            dropdowns() {
        ...
        events: [{
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const s = Math.max(...Te(t, `.${this.clsDrop}`).concat(t).map(n => I(n).bottom));
                        I(this.dropbar, {
        ...
        methods: {
            ...
            async transitionTo(t, e) {
                ...
                if (e = s < t && e, await O.cancel([e, i]), e) {
                    const n = I(e).top - I(i).top - s;
                    n > 0 && c(e, "transitionDelay", `${n/t*this.duration}ms`)
                }
                c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`), it(i, s), await Promise.all([O.start(i, {
                    height: t
                }, this.duration), O.start(e, {
    ...
    var Ul = {
            ...
            update() {
                ...
                const n = Ui(e) ? "value" : "textContent",
                    o = e[n],
                    r = (t = i.files) != null && t[0] ? i.files[0].name : E(i, "select") && (s = z("option", i).filter(a => a.selected)[0]) ? s.textContent : i.value;
                o !== r && (e[n] = r)
            },
            events: [{
                name: "change",
        ...
        Vl = {
            ...
            connected() {
                this.masonry && $(this.$el, "bdt-flex-top", "bdt-flex-wrap-top")
            },
            observe: Le({
                filter: ({
                    parallax: t,
            ...
            update: [{
                ...
                read(t) {
                    ...
                    const h = a.map(x => zt(x, "offsetHeight") + r * (x.length - 1)),
                        u = Math.max(0, ...h);
                    let d, f, v;
        ...
        for (let a of t) {
            ...
            for (const h in a) {
                const {
                    offsetWidth: u,
                    offsetHeight: d
                } = a[h], f = i ? h : o.indexOf(Math.min(...o));
                _s(s, f, a[h]), _s(n, f, [(f - h) * u * (V ? -1 : 1), o[f] - r]), o[f] += d + e, l = Math.max(l, d)
            }
            r += l + e
        }
        return [s, n]
    ...
    var Jl = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? ms(this.elements) : [this.elements]).map(Kl)
                }
            },
            write({
                rows: t
    ...
    var Ql = {
        ...
        th = {
            ...
            update: {
                read() {
                    ...
                    let t = "";
                    const e = De(this.$el, "height", "content-box"),
                        {
                            body: i,
                            scrollingElement: s
                        } = document,
                    ...
                    if (t = `calc(${r?"100vh":`${o}px`}`, this.expand) {
                        ...
                        if (this.offsetTop)
                            if (r) {
                                const a = this.offsetTop === !0 ? this.$el : J(this.offsetTop, this.$el),
                                    l = Rt(a)[0] - Rt(n)[0];
                                t += l > 0 && l < o / 2 ? ` - ${l}px` : ""
        ...
        eh = '<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',
        ih = '<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',
        sh = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        nh = '<svg width="20" height="20" viewBox="0 0 20 20"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',
        oh = '<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',
        rh = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        ah = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        lh = '<svg width="20" height="20" viewBox="0 0 20 20"><style>.bdt-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.bdt-navbar-toggle-icon svg&gt;.line-3{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect class="line-1" y="3" width="20" height="2"/><rect class="line-2" y="9" width="20" height="2"/><rect class="line-3" y="9" width="20" height="2"/><rect class="line-4" y="15" width="20" height="2"/></svg>',
        hh = '<svg width="40" height="40" viewBox="0 0 40 40"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',
        ch = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',
        uh = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',
        zo = '<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',
        dh = '<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',
        fh = '<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',
        ph = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',
        gh = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',
        mh = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>',
        vh = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',
        wh = '<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',
        bh = '<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',
        Fo = {
            args: "src",
            props: {
                width: Number,
    ...
    const Di = {
        ...
        kh = {
            ...
            beforeConnect() {
                const t = y(this.$el, "bdt-search-toggle") || y(this.$el, "bdt-navbar-toggle");
                if (this.icon = t ? "search-toggle-icon" : y(this.$el, "bdt-search-icon") && oi(this.$el, ".bdt-search-large") ? "search-large" : oi(this.$el, ".bdt-search-navbar") ? "search-navbar" : this.$props.icon, !Tt(this.$el, "aria-label"))
                    if (t) {
        ...
        Lo = {
            extends: Zt,
            beforeConnect() {
                $(this.$el, "bdt-slidenav");
                const t = this.$props.icon;
                this.icon = y(this.$el, "bdt-slidenav-large") ? `${t}-large` : t
            }
        },
        Ih = {
            extends: Zt,
        ...
        Ch = {
            ...
            beforeConnect() {
                this.icon = `close-${y(this.$el,"bdt-close-large")?"large":"icon"}`
            }
        },
        Th = {
            extends: Zt,
    ...
    function Hh(t) {
        ...
        return Q(t) || (t = [t]), t.filter(e => !ti(e))
    }
    ...
    var Lh = {
        ...
        observe: [ps({
            ...
            observe: (t, e) => {
                const i = Be([...t, document.documentElement], e),
                    s = [b(document, "scroll itemshown itemhidden", e, {
                        passive: !0,
                        capture: !0
                    }), b(document, "show hide transitionstart", n => (e(), i.observe(n.target))), b(document, "shown hidden transitionend transitioncancel", n => (e(), i.unobserve(n.target)))];
                return {
                    disconnect() {
        ...
        update: {
            read() {
                for (const t of this.target) si(t, "bdt-light,bdt-dark", !this.selActive || E(t, this.selActive) ? Wh(t) : "")
            }
        }
    };
    ...
    var jh = {
            ...
            computed: {
                fill: ({
                    fill: t
                }, e) => t || c(e, "--bdt-leader-fill-content")
            },
            connected() {
        ...
        Rh = {
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    y(this.panel, "bdt-margin-auto-vertical") ? $(this.$el, "bdt-flex") : c(this.$el, "display", "block"), it(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
                handler() {
                    c(this.$el, "display", ""), D(this.$el, "bdt-flex")
                }
            }]
        };
    ...
    function qh({
        ...
        t.dialog = function(i, s) {
            const n = t(`<div class="bdt-modal"> <div class="bdt-modal-dialog">${i}</div> </div>`, {
                stack: !0,
                role: "alertdialog",
                ...s
            });
            ...
            return e(({
                i18n: n
            }) => `<div class="bdt-modal-body">${N(i)?i:Lt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="bdt-modal-body">${N(i)?i:Lt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
        }, t.prompt = function(i, s, n) {
            const o = e(({
                    i18n: l
                }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${N(i)?i:Lt(i)}</label> <input class="bdt-input" value="${s||""}" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${l.cancel}</button> <button class="bdt-button bdt-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value),
                {
                    $el: r
                } = o.dialog,
                a = k("input", r);
    ...
    const Ms = "bdt-navbar-transparent";
    var Vh = {
        extends: Mo,
        props: {
        ...
        watch: {
            items() {
                const t = y(this.$el, "bdt-navbar-justify"),
                    e = z(".bdt-navbar-nav, .bdt-navbar-left, .bdt-navbar-right", this.$el);
                for (const i of e) {
                    const s = t ? z(".bdt-navbar-nav > li > a, .bdt-navbar-item, .bdt-navbar-toggle", i).length : "";
                    c(i, "flexGrow", s)
                }
            }
        },
        ...
        methods: {
            getTransparentMode(t) {
                ...
                const e = this.getDropdown(t);
                if (e && y(t, "bdt-dropbar")) return e.inset ? "behind" : "remove"
            },
            getDropbarOffset(t) {
                const {
                    top: e,
    ...
    var Kh = {
        ...
        Zh = {
            props: ["width", "height"],
            connected() {
                $(this.$el, "bdt-responsive-width"), c(this.$el, "aspectRatio", `${this.width}/${this.height}`)
            }
        },
        Qh = {
            props: {
    ...
    function Ro(t) {
        if (!t.defaultPrevented)
            for (const e of Ke) e.$el.contains(t.target) && ne(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Vi(e.$el)))
    }
    var ic = {
            args: "cls",
            props: {
            ...
            observe: Fe({
                ...
                handler(t) {
                    ...
                    for (const {
                        ...
                        e.has(i) || e.set(i, {
                            cls: X(i, "bdt-scrollspy-class") || this.cls
                        });
                        const n = e.get(i);
            ...
            methods: {
                toggle(t, e) {
                    ...
                    if (s) {
                        if ((i = s.off) == null || i.call(s), c(t, "opacity", !e && this.hidden ? 0 : ""), j(t, this.inViewClass, e), j(t, s.cls), /\bbdt-animation-/.test(s.cls)) {
                            const n = () => Ri(t, "bdt-animation-[\\w-]+");
        ...
        nc = {
            ...
            connected() {
                this.start = qo(this.start || this.top), this.end = qo(this.end || this.bottom), this.placeholder = k("+ .bdt-sticky-placeholder", this.$el) || k('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
            ...
            update: [{
                read({
                    ...
                    n && (Ns(this.target), this.hide()), this.active || ({
                        height: t,
                        width: e
                    } = I(this.$el), i = c(this.$el, "margin")), n && this.show();
                    const o = U("100vh", "height"),
                        r = it(window),
                    ...
                    const d = this.overflowFlip ? 0 : Math.max(0, t + u - o),
                        f = I(h).top,
                        v = I(this.$el).height,
                        x = (this.start === !1 ? f : Bs(this.start, this.$el, f)) - u,
                        C = this.end === !1 ? a : Math.min(a, Bs(this.end, this.$el, f + t, !0) - v - u + d);
                ...
                write({
                    ...
                    c(o, {
                        ...
                        width: e,
                        margin: i
                    }), (P(o) !== P(this.$el) || n ^ Et(o) < Et(this.$el)) && ((n ? li : hi)(this.$el, o), o.hidden = !0)
                },
                events: ["resize"]
            }, {
                read({
                ...
                write(t, e) {
                    ...
                    if ((d - s > 300 || n !== o) && (t.initScroll = r, t.initTimestamp = d), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                        if (this.inactive || r < h || this.showOnUp && (r <= h || n === "down" && i || n === "up" && !this.isFixed && !u)) {
                            ...
                            if (this.animation && u) {
                                if (y(this.$el, "bdt-animation-leave")) return;
    ...
    function Ns(t) {
        $(t, "bdt-transition-disable"), requestAnimationFrame(() => D(t, "bdt-transition-disable"))
    }
    var oc = {
        mixins: [Fo],
        args: "src",
    ...
    const zs = ".bdt-disabled *, .bdt-disabled, [disabled]";
    var Go = {
            mixins: [Vt],
            args: "connect",
            props: {
            ...
            events: [{
                ...
                handler(t) {
                    !E(t.current, zs) && (t.type === "click" || t.keyCode === _.SPACE) && (t.preventDefault(), this.show(t.current))
                }
            }, {
                name: "keydown",
                delegate() {
                ...
                name: "click",
                el() {
                    return this.connects.concat(this.itemNav ? Ee(this.itemNav, this.$el) : [])
                },
                delegate() {
                    return `[${this.attrItem}],[data-${this.attrItem}]`
                },
            ...
            methods: {
                ...
                show(t) {
                    const e = this.toggles.filter(r => !E(r, zs)),
                        i = this.index(),
        ...
        cc = {
            ...
            connected() {
                const t = y(this.$el, "bdt-tab-left") ? "bdt-tab-left" : y(this.$el, "bdt-tab-right") ? "bdt-tab-right" : !1;
    ...
    var dc = {
            ...
            computed: {
                target({
                    ...
                    return t = Ee(t || e.hash, e), t.length ? t : [e]
                }
            },
            connected() {
            ...
            events: [{
                ...
                handler(t) {
                    ...
                    const e = m(["mouseenter", he, "focus"], t.type),
                        i = this.isToggled(this.target);
                    if (!e && (!ie(this._showState) || t.type !== "blur" && E(this.$el, ":focus") || t.type === "blur" && E(this.$el, ":hover"))) {
                ...
                handler(t) {
                    let e;
                    (this._preventClick || t.target.closest('a[href="#"], a[href=""]') || (e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || e.hash && E(this.target, e.hash))) && t.preventDefault(), !this._preventClick && m(this.mode, "click") && this.toggle()
                }
            }, {
                name: "mediachange",
                filter() {
            ...
            methods: {
                async toggle(t) {
                    ...
                    if (Tt(this.$el, "aria-expanded") && p(this.$el, "aria-expanded", !this.isToggled(this.target)), !this.queued) return this.toggleElement(this.target);
    ...
    return Nt(fc, (t, e) => ut.component(e, t)), Pl(ut), Nt(El, (t, e) => ut.component(e, t)), ut
});